image:https://github.com/couchbase/docs-sdk-java/actions/workflows/build.yml/badge.svg?branch=release%2F3.3[link="https://github.com/couchbase/docs-sdk-java/actions/workflows/build.yml"] 
