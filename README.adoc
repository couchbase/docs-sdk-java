...
This repository hosts the documentation source for the https://docs.couchbase.com/java-sdk/3.12/hello-world/overview.html[Couchbase Java SDK].

This branch documents the 3.12 release of the SDK.
It follows the https://docs.couchbase.com/java-sdk/3.11/project-docs/compatibility.html#api-version[SDK 3.10 API].

This branch reflects the new Information Architecture for the SDK docs, helping to guide new-to-Couchbase users through the pitfalls of a complex distributed system.
...
| `name-sdk:` | Allows us to name the SDK within shared content (*Java SDK*).
...
Production branches use the *release/x.y* naming pattern (e.g. `release/3.12`, `release/3.11`).
