image:https://github.com/couchbase/docs-sdk-java/actions/workflows/build.yml/badge.svg[link="https://github.com/couchbase/docs-sdk-java/actions/workflows/build.yml"] 
