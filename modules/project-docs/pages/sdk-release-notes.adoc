...
include::{version-common}@sdk:shared:partial$relnotes.adoc[tag=intro]


=== Installation

include::{version-common}@sdk:shared:partial$relnotes.adoc[tag=installation-moved]

// JVM signed
include::{version-common}@sdk:shared:partial$relnotes.adoc[tag=signed]
...
Version {sdk_dot_minor} of the Java SDK implements the {sdk-api} xref:compatibility.adoc#api-version[SDK API].
...
[v3.13.0]
=== Version 3.13.0 (08 October 2026)
...
include::{version-common}@sdk:shared:partial$relnotes.adoc[tag=older]
// end::all[]
