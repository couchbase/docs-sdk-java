...
Add Javadocs and polish Eventing Management API.
* https://issues.couchbase.com/browse/JVMCBC-1013[JVMCBC-1013]:
Move N1QL prepared statement cache into core-io.
...
Batch-Log overflow messages in the DefaultEventBus.

=== Bugs
* https://issues.couchbase.com/browse/JCBC-1873[JCBC-1873]:
EventingFunction validate_ssl_certificates field incorrectly named.
* https://issues.couchbase.com/browse/JVMCBC-1017[JVMCBC-1017]:
Threshold Logging Tracing not working due to context not being set.
* https://issues.couchbase.com/browse/JVMCBC-1019[JVMCBC-1019]:
CoreQueryAccessor issues redundant query requests.
