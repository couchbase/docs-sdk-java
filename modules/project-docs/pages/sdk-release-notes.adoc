...
* http://issues.couchbase.com/browse/JCBC-1637[JCBC-1637]:
ConfigurationProvider now provides a seedNodes() Flux, allowing the application to be informed when all address resolution is complete and the final seed-nodes hostnames are known
...
* http://issues.couchbase.com/browse/JCBC-1635[JCBC-1635]:
Subscribing to DefaultConfigurationProvider.configs() will now correctly replay the current config
