...
[JVMCBC-1654](https://couchbasecloud.atlassian.net/browse/JVMCBC-1654) Replica reads and KV range scan fail to time out if bucket does not exist, and can lead to OOM
