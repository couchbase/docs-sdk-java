...
The behavior has now been changed so that even if the map never moves forward and the operation has been retried it will make progress eventually and complete.
