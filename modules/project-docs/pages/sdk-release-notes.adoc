...
=== Bug Fixes
* https://issues.couchbase.com/browse/JCBC-1713[JCBC-1713]: LDAP authentication fails on TLS connections.
* https://issues.couchbase.com/browse/JCBC-1718[JCBC-1718]: Incorrect interpretation of the &quot;expiry&quot;.
...
=== Enhancements
* https://issues.couchbase.com/browse/JCBC-1651[JCBC-1651]: Geopolygon search support
* https://issues.couchbase.com/browse/JCBC-1652[JCBC-1652]: Add Options To Use FTS Hints (Flex Index)
* https://issues.couchbase.com/browse/JCBC-1695[JCBC-1695]: Add support to pass Score as FTS parameter
* https://issues.couchbase.com/browse/JCBC-1707[JCBC-1707]: Retrofit Geo Search Queries to allow Coordinate Usage
* https://issues.couchbase.com/browse/JCBC-1709[JCBC-1709]: Allow to access ReactiveScope from Scope
* https://issues.couchbase.com/browse/JCBC-1712[JCBC-1712]: Clarify Javadoc lockTime on getAndLock
* https://issues.couchbase.com/browse/JCBC-1715[JCBC-1715]: Allow to provide custom http headers for the RawManager
* https://issues.couchbase.com/browse/JCBC-1717[JCBC-1717]: Support for targeting requests to a given node
