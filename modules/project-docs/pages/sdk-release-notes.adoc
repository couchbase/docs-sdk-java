...
Version 3.12 of the Java SDK implements the 3.9 xref:compatibility.adoc#api-version[SDK API].
...
=== Version 3.12.3 (10 September 2026)

https://packages.couchbase.com/clients/java/3.12.3/Couchbase-Java-Client-3.12.3.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.12.3/index.html[API Reference] |
https://docs.couchbase.com/sdk-api/couchbase-core-io-3.12.3/[Core API Reference]
...
* https://jira.issues.couchbase.com/browse/JVMCBC-1762[JVMCBC-1762]:
Returning a failed future from `RetryStrategy.shouldRetry()` now causes the request to fail immediately instead of timing out, and propagates the exception from the failed future.
+
Thank you to community member https://github.com/1fanwang[Stefan Wang].

* https://jira.issues.couchbase.com/browse/JVMCBC-1760[JVMCBC-1760]:
Upgraded to Netty `4.2.18`.

* https://jira.issues.couchbase.com/browse/JVMCBC-1761[JVMCBC-1761]:
Upgraded to Jackson `2.21.6`.

==== Bug Fixes

* https://jira.issues.couchbase.com/browse/JVMCBC-1759[JVMCBC-1759]:
The `couchbase2://` protocol now correctly throws `NumberTooBigException` when a subdocument operation fails for that reason.


=== Version 3.12.2 (28 July 2026)

https://packages.couchbase.com/clients/java/3.12.2/Couchbase-Java-Client-3.12.2.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.12.2/index.html[API Reference] |
...
https://packages.couchbase.com/clients/java/3.12.1/Couchbase-Java-Client-3.12.1.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.12.1/index.html[API Reference] |
...
* https://jira.issues.couchbase.com/browse/JVMCBC-1749[JVMCBC-1749]:
Fixed a regression in `3.12.0` that prevented Spring Data Couchbase from executing transactions.
...
* https://jira.issues.couchbase.com/browse/JCBC-2214[JCBC-2214]:
Adds a new API to `Collection`, `getOrNull`.
This behaves identically to the regular Key-Value get call except that if the document does not exist then null is returned rather than an exception being raised,
avoiding the slight overhead of exception creation on JVM platforms.
In addition, when `OpenTelemetry` is being used an exception is not attached to the span in that case.
...
https://packages.couchbase.com/clients/java/3.11.3/Couchbase-Java-Client-3.11.3.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.11.3/index.html[API Reference] |
...
When `SecurityConfig.trustCertificate(Path)` fails to parse the specified file, the exception message no longer includes the file contents.
...
* https://jira.issues.couchbase.com/browse/JCBC-2211[JCBC-2211]:
Added an optional `Jackson3JsonSerializer` which uses Jackson 3 for data binding.
[CAUTION]
The new `Jackson3JsonSerializer` does not support the `@Encrypted` annotation for automatic Field-Level Encryption.
If your application relies on this feature, please continue using Jackson 2 for now.
...
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.10.1/index.html[API Reference] |
...
* https://jira.issues.couchbase.com/browse/JVMCBC-1709[JVMCBC-1709]: Enabling TLS inside an OSGi container no longer causes `java.lang.ClassNotFoundException: javax.net.ssl.TrustManagerFactory not found by core-io`.
...
* https://jira.issues.couchbase.com/browse/JCBC-2206[JCBC-2206]: Deprecated the Views API.
+
...
=== Version 3.9.3 (12 August 2026)

This release backports the Netty and Jackson version updates from SDK 3.12.1 to the 3.9.x line.

https://packages.couchbase.com/clients/java/3.9.3/Couchbase-Java-Client-3.9.3.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.9.3/index.html[API Reference] |
http://docs.couchbase.com/sdk-api/couchbase-core-io-3.9.3/[Core API Reference]
...
* https://jira.issues.couchbase.com/browse/JVMCBC-1757[JVMCBC-1757]:
Upgrade `Netty` from `4.1.127` to `4.1.136`.

* https://jira.issues.couchbase.com/browse/JVMCBC-1758[JVMCBC-1758]:
Upgrade `Jackson` from `2.19.2` to `2.21.5`.
...
https://packages.couchbase.com/clients/java/3.7.7/Couchbase-Java-Client-3.7.7.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.7.7/index.html[API Reference] |
...
Added experimental queryStreaming methods to Cluster and Scope. These methods let you process SQL++ query result rows as they arrive from the server, without having to use the Reactive API. See the Javadoc for details. Example usage:
[source,java]
----
...
=== Version 3.7.6 (04 December 2024)

This is the sixth maintenance release of the 3.7 series.

https://packages.couchbase.com/clients/java/3.7.6/Couchbase-Java-Client-3.7.6.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.7.6/index.html[API Reference] |
...
* https://jira.issues.couchbase.com/browse/JCBC-2173[JCBC-2173]:
Upgraded `jctools-core` to `4.0.5`.
* https://jira.issues.couchbase.com/browse/JCBC-2175[JCBC-2175]:
Separated `MpscArrayQueue` creation in certain classes.


=== Version 3.7.5 (06 November 2024)

This is the fifth maintenance release of the 3.7 series.

https://packages.couchbase.com/clients/java/3.7.5/Couchbase-Java-Client-3.7.5.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.7.5/index.html[API Reference] |
...
Due to a regression in 3.7.1, using a secure connection would cause `waitUntilReady()` to not wait, and would cause `ping()` to report failures even when nothing was wrong.
The issue that caused these problems is now fixed.
* https://jira.issues.couchbase.com/browse/JVMCBC-1577[JVMCBC-1577]:
Due to a regression in 3.7.1, sometimes a request made shortly after calling `Cluster.connect()` would fail with a message that said the service is not available in the cluster, even if the service was actually available.
...
* https://jira.issues.couchbase.com/browse/JVMCBC-1576[JVMCBC-1576]:
Bumped `protobuf` version from `3.23.2` to `3.25.5`.
* https://jira.issues.couchbase.com/browse/JCBC-2167[JCBC-2167]:
When using the Reactive API, it’s now possible to specify the default Scheduler results are published on.
The new `ClusterEnvironment.Builder.publishOnScheduler(Supplier<Scheduler>)` method takes a supplier that the SDK invokes every time you subscribe to a Mono/Flux.
The supplier is invoked by the same thread that does the subscription.
+
WARNING: This new configuration option is `volatile` API, meaning it could change without notice as we refine it based on your feedback.

* https://jira.issues.couchbase.com/browse/JCBC-2169[JCBC-2169]:
QueryMetrics now has a useful `.toString()` method.


=== Version 3.7.4 (08 October 2024)

This is the fourth maintenance release of the 3.7 series.

https://packages.couchbase.com/clients/java/3.7.4/Couchbase-Java-Client-3.7.4.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.7.4/index.html[API Reference] |
...
* https://jira.issues.couchbase.com/browse/JCBC-2147[JCBC-2147]:
...
https://packages.couchbase.com/clients/java/3.7.1/Couchbase-Java-Client-3.7.3.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.7.3/index.html[API Reference] |
...
* https://jira.issues.couchbase.com/browse/JCBC-2095[JCBC-2095]:
Transactions, `ExtParallelUnstaging` -- Commit and rollback documents in parallel, keeping concurrency to a max of 1000.
...
=== Version 3.7.2 (13 August 2024)

This is the second maintenance release of the 3.7 series.

https://packages.couchbase.com/clients/java/3.7.2/Couchbase-Java-Client-3.7.2.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.7.2/index.html[API Reference] |
...
=== Version 3.7.1 (23 July 2024)

This is the first maintenance release of the 3.7 series.

https://packages.couchbase.com/clients/java/3.7.1/Couchbase-Java-Client-3.7.1.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.7.1/index.html[API Reference] |
...
|=======================
| Artifact                  | Couchbase Version | Built Against              | API Stability
| `tracing-opentelemetry`   | 1.4.4             | OpenTelemetry 1.31.0       | Committed
| `tracing-opentracing`     | 1.4.4             | OpenTracing 0.33.0         | Committed
| `metrics-opentelemetry`   | 0.6.4             | OpenTelemetry 1.31.0       | Volatile
| `metrics-micrometer`      | 0.6.4             | Micrometer 1.10.10         | Volatile
|=======================
...
Thank you to community member Omer Cilingir <omer.cilingir@bkm.com.tr> for this contribution.
+
NOTE: This is a backport of a feature from version 3.12.0.
It is not present in SDK versions before 3.12.0 unless mentioned in the release notes.

=== Version 3.6.3 (19 August 2024)

This is a regular maintenance release.

https://packages.couchbase.com/clients/java/3.6.3/Couchbase-Java-Client-3.6.3.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.6.3/index.html[API Reference] |
...
* https://issues.couchbase.com/browse/JVMCBC-1540[JVMCBC-1540]:
This release improves compatibility with Spring Data Couchbase by reversing an internal API change present in Couchbase Java SDK 3.6.2 and 3.7.0,
that prevented upgrading to the latest Couchbase SDK independently of the Spring Data Couchbase version.
* https://issues.couchbase.com/browse/JVMCBC-1532[JVMCBC-1532], https://issues.couchbase.com/browse/JCBC-2160[JCBC-2160]:
...
=== Version 3.5.4 (27 April 2026)

This is a maintenance release.

https://packages.couchbase.com/clients/java/3.5.4/Couchbase-Java-Client-3.5.4.zip[Download] |
https://docs.couchbase.com/sdk-api/couchbase-java-client-3.5.4/index.html[API Reference] |
http://docs.couchbase.com/sdk-api/couchbase-core-io-2.5.4/[Core API Reference]
...
|=======================
| Artifact                  | Couchbase Version | Built Against              | API Stability
| `tracing-opentelemetry`   | 1.3.4             | OpenTelemetry 1.31.0       | Committed
| `tracing-opentracing`     | 1.3.4             | OpenTracing 0.33.0         | Committed
| `metrics-opentelemetry`   | 0.5.4             | OpenTelemetry 1.31.0       | Volatile
| `metrics-micrometer`      | 0.5.4             | Micrometer 1.10.9          | Volatile
|=======================
