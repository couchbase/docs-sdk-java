...
Added an `io.configNotifications` client setting. If advised by Couchbase Technical Support, set this to false to disable server-initiated cluster topology change notifications.
