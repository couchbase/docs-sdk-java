...
Eventing constant and URL binding issues.
...
`ConflictResolutionType.CUSTOM` added to the bucket management API.
...
Add convenience methods for loading eventing function JSON.
* https://issues.couchbase.com/browse/JCBC-1909[JCBC-1909]:
Add scanWait to AnalyticsOptions.
* https://issues.couchbase.com/browse/JCBC-1903[JCBC-1903]:
Add javadocs for bucket management API.
* https://issues.couchbase.com/browse/JCBC-1908[JCBC-1908]:
Add javadocs for query index management APIs.
