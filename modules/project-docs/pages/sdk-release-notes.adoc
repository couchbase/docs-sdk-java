...
This low-impact, and only affects developers who use the `couchbase2://` protocol and specify the "consistent with" option when querying or searching.
