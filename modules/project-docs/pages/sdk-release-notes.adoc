...
Rate limited exceptions not thrown for SearchIndexManager errors.
* https://issues.couchbase.com/browse/JVMCBC-1071[JVMCBC-1071]:
Prevent negative value to be sent to ValueRecorder.
...
Quote index fields in the analytics index manager.
* https://issues.couchbase.com/browse/JCBC-1921[JCBC-1921]:
QueryIndexManager buildDeferredIndexes throws ParsingFailureException against CB 6.0.

=== New Features
* https://issues.couchbase.com/browse/JVMCBC-1057[JVMCBC-1057]:
Add core infrastructure for the Backup service.
...
Explicitly handle FeatureNotAvailable for Magma on CE.
* https://issues.couchbase.com/browse/JVMCBC-1069[JVMCBC-1069]:
Explicitly handle FeatureNotAvailable for Query CE.
* https://issues.couchbase.com/browse/JCBC-1916[JCBC-1916]:
Update Analytics Management API Javadocs.
