...
Fixed a regression in Couchbase Java SDK 3.4.5 and Scala SDK 1.2.5 that prevented Full-Text Search result rows from including an explanation when requested.
