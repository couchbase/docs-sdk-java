...
Transactions - Commit and rollback documents in parallel, keeping concurrency to a max of 1000.
...
Update depdency versions. netty:4.1.122.Final, HdrHistogram:2.2.2, reactor:3.6.9, blockhound:1.0.9.RELEASE, micrometer:1.12.9, grpc1.66.0, micrometer-tracing:1.3.3 
