...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=timeoutbuilder,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=shutdown,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=sysprops,indent=0]
----

[source,java]
----
include::devguide:example$java/Migrating.java[tag=connstr,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=rbac,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=rbac-full,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=certauth,indent=0]
----
...
[source,java]
----
include::devguide:example$java/MigratingSDKCodeTo3n.java[tag=migrating_sdk_code_to_3_n_11,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=simpleget,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=upsertandget,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=rawjson,indent=0]
----
...
[source,java]
----
include::devguide:example$java/MigratingSDKCodeTo3n.java[tag=subdoc_mutatein_store_semantics,indent=0]
----
====
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=customtimeout,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=querysimple,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=queryparameterized,indent=0]
----
...
[source,java]
----
include::devguide:example$java/MigratingSDKCodeTo3n.java[tag=migrating_sdk_code_to_3_n_22,indent=0]
----
...
The fluent API feature in SDK 2.x was found not to scale well for larger queries, nor for {sqlpp}.
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=analyticssimple,indent=0]
----

[source,java]
----
include::devguide:example$java/Migrating.java[tag=analyticsparameterized,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=searchsimple,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=searchcheck,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Migrating.java[tag=viewquery,indent=0]
----
...
include::{version-common}@sdk:shared:partial$compat.adoc[tag=migration]
