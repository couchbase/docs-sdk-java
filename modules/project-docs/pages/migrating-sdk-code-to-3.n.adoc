...
The fluent API feature tried out in SDK 2 was found not to scale well for larger queries, nor for SQL++.
There was also some impedance mismatch with the Java language.
For these reaasons it is not amongst the features initially carried over to SDK 3.0.
