...
Now, it will happen on all bucket in the cluster, as intended.
...
* https://issues.couchbase.com/browse/TXNJ-313[TXNJ-313], https://issues.couchbase.com/browse/TXNJ-334[TXNJ-334],https://issues.couchbase.com/browse/TXNJ-354[TXNJ-354]:
...
Fetching a document's ATR entry now correctly uses that that ATR's collection.
