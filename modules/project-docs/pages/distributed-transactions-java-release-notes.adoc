...
Solves a potential rare data race issue where a transaction that expires immediately after beginning the commit phase, could in theory have its staged changes overwritten by another transaction.
