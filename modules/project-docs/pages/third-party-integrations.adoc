...
Liquibase manages schema changes, storing changes in text files as XML, YAML, JSON, or SQL. It is often used as a migration tool, and Liquibase have made available a https://github.com/liquibase/liquibase-couchbase[Couchbase extension for Liquibase] for Couchbase Server 7.x.
