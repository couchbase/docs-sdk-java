...
[source,java]
----
include::devguide:example$java/TransactionsMigration.java[tag=access,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsMigration.java[tag=config,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsMigration.java[tag=config-cleanup,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsMigration.java[tag=single-query,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsMigration.java[tag=single-query-config,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsMigration.java[tag=log,indent=0]
----
