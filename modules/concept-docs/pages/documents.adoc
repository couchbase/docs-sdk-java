...
// :page-aliases: ROOT:documents.adoc,ROOT:documents-basics.adoc,ROOT:documents-atomic.adoc,ROOT:core-operations.adoc,7.2@server:developer-guide:expiry.adoc,7.2@server:developer-guide:creating-documents.adoc
