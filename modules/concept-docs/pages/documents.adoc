...
:page-toclevels: 2
// :page-aliases: ROOT:documents.adoc,ROOT:documents-basics.adoc,ROOT:documents-atomic.adoc,ROOT:core-operations.adoc
...
[source,java,indent=0]
----
include::devguide:example$java/DocumentsExample.java[tag=lookup-in]
----
...
[source,java,indent=0]
----
include::devguide:example$java/DocumentsExample.java[tag=counters]
----
...
[source,java,indent=0]
----
include::devguide:example$java/DocumentsExample.java[tag=counter-increment]
----
