...
* xref:enterprise-analytics:intro:intro.adoc[Enterprise Analytics] & xref:analytics:intro:intro.adoc[Capella Analytics] for real-time analytics, with data stored elsewhere in your data lake.
