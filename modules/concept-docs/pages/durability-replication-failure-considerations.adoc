...
:page-aliases: 6.0@server:sdk:durability.adoc, 6.5@server:sdk:durability.adoc, 6.6@server:sdk:durability.adoc
...
For now, much of the discussion (concept-level documentation) can still be found interleaved in the xref:howtos:error-handling.html#exception-handling[practical error handling howto doc].
