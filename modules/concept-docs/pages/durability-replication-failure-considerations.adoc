...
For now, much of the discussion (concept-level documentation) can still be found interleaved in the xref:howtos:error-handling.html#exception-handling[practical error haedling howto doc].
