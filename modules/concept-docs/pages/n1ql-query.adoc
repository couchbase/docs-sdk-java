...
[source,java]
----
include::example$n1ql_query.java[tag=n1ql_query_1,indent=0];
----
...
[source,java]
----
include::example$n1ql_query.java[tag=n1ql_query_2,indent=0];
----
...
[source,java]
----
include::example$n1ql_query.java[tag=n1ql_query_3,indent=0];
----
...
[source,java]
----
include::example$n1ql_query.java[tag=n1ql_query_4,indent=0];
----
...
[source,java]
----
include::example$n1ql_query.java[tag=n1ql_query_5,indent=0];
----
