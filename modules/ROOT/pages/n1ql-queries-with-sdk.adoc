...
For more information on query parameters in N1QL, see xref:4.6@server:n1ql:n1ql-rest-api/index.adoc[N1QL REST API].
...
WHERE ANY child IN tutorial.children SATISFIES child.age >= 12 END;
----
