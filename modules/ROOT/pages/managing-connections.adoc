...
:page-aliases: howtos:managing-connections,howtos:multi-network,connecting,connection-advanced,4.6@server:developer-guide:connection-advanced
...
include::4.6@sdk:shared:partial$dnssrv-pars.adoc[tag=dnssrv]
