...
You can issue N1QL queries using either a Couchbase SDK, the _cbq_ shell, the _cbc_ command line tool, the REST API, or the xref:6.o@server:tools:query-workbench.adoc[Query workbench].
