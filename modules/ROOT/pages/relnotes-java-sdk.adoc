...
Version 2.7.0 is the first stable release of the 2.7 series, bringing new
...
endpoint for querying (from /query/service to /analytics/service).
...
objects returned in the query metrics.
