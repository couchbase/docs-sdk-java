...
*Important*: At least Java 7 is required, all newer Java versions are
...
This release upgrades the Jackson databind dependency version to 2.9.7 due to the vulnerabilities https://nvd.nist.gov/vuln/detail/CVE-2017-17485[CVE-2017-17485] & https://nvd.nist.gov/vuln/detail/CVE-2018-7489[CVE-2018-7489] identified in the versions used in the previous releases. As the newer Jackson dependency uses Java 7 language features, the SDK is no longer compabitible with Java 6.

=== Enhancements & New Features

* http://issues.couchbase.com/browse/JCBC-1253[JCBC-1253]: 
Adds support for sub document expansion of macro in extended attributes. This is intended for internal use for other dependent couchbase libraries.
...
* http://issues.couchbase.com/browse/JVMCBC-579[JVMCBC-579]: Fixes the RTO threshold logging to use descending order instead of ascending as mandated in the design document.
* http://issues.couchbase.com/browse/JCBC-1255[JCBC-1255]: Allows crypto transcoder to also trancode docs with no encryption requirements.
