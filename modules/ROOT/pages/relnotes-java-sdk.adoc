...
http://packages.couchbase.com/clients/java/2.7.0/Couchbase-Java-Client-2.6.2.zip[Download] | http://docs.couchbase.com/sdk-api/couchbase-java-client-2.7.0/[API
...
* http://issues.couchbase.com/browse/JVMCBC-570[JVMCBC-570]: Switched to the new 
