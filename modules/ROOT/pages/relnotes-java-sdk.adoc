...
Version 2.7.2 is the third release of the 2.7 series, bringing new features, enhancements, and bugfixes over the last stable release. As of this release, OpenJDK 11 is fully supported. See the xref:compatibility-versions-features.adoc[Compatibility] section for details.
