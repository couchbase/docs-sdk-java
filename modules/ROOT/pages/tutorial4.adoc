...
NOTE: For reference, you can find the previous tutorial that focuses more on key/value operations and views (since N1QL was introduced in CB 4.0): xref:tutorial3.adoc[Java SDK tutorial for CB 3.x].
