...
The reference for the latest version can be found https://docs.couchbase.com/sdk-api/couchbase-java-client-2.7.12/[here^].
...
It is designed to be quite low level and only exposes a message-oriented API -- the API reference is https://docs.couchbase.com/sdk-api/couchbase-core-io-1.7.12/[here^].

Links to older versions of the API docs can be found on the xref:sdk-release-notes.adoc[Release Notes page], and links to the new 3.0 SDK API docs can be found on the xref:3.0@java-sdk:project-docs:sdk-release-notes.adoc[3.0 Release Notes page].
