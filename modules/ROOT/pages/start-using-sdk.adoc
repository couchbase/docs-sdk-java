...
include::4.6@sdk:shared:partial$install-couchbase.adoc[tag=section_gb4_psc_kv]
...
Information on new features, fixes, known issues as well as information on how to install older release versions is xref:2.6@relnotes-java-sdk.adoc#version-2-4-8-18-october-2017[in the release notes].
...
See https://developer.couchbase.com/documentation/server/5.0/sdk/java/sdk-authentication-overview.html[Authentication^], for information.
...
Now that the [.api]`Cluster` reference is available, you can open [.api]`Bucket` instances and then perform operations on them:
...
The reference for the latest version can be found http://docs.couchbase.com/sdk-api/couchbase-java-client-2.6.0/[here^].
