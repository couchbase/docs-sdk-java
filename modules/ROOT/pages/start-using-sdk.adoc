...
Information on new features, fixes, known issues as well as information on how to install older release versions is link:/server/other-products/release-notes-archives/java-sdk[in the release notes].
