...
Information on new features, fixes, known issues as well as information on how to install older release versions is xref:/java-sdk/relnotes-java-sdk[in the release notes].
