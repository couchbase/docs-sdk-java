...
Information on new features, fixes, known issues as well as information on how to install older release versions is xref:relnotes-java-sdk.adoc#version-2-4-8-18-october-2017[in the release notes].
