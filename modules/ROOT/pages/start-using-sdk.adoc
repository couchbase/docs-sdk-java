...
:page-aliases: getting-started,hello-couchbase,java-intro
...
Note that not all nodes of the cluster need to be passed in it, just a few to allow it to bootstrap itself are enough.
...
The reference for the latest version can be found http://docs.couchbase.com/sdk-api/couchbase-java-client-2.7.7/[here^].
