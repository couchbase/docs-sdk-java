...
Information on new features, fixes, known issues as well as information on how to install older release versions is xref:relnotes-java-sdk.adoc#version-2-6-2-4-september-2018[in the release notes].
