...
Information on new features, fixes, known issues as well as information on how to install older release versions is xref:relnotes-java-sdk.adoc#version-2-5-9-7-june-2018[in the release notes].
