...
include::5.1@sdk:shared:partial$install-couchbase.adoc[tag=section_gb4_psc_kv]
...
Information on new features, fixes, known issues as well as information on how to install older release versions is xref:2.6@java-sdk::relnotes-java-sdk.adoc#version-2-5-9-7-june-2018[in the release notes].
