...
Information on new features, fixes, known issues as well as information on how to install older release versions is 
xref:relnotes-java-sdk.adoc#version-2-3-7-19-january-2017[in the release notes].
