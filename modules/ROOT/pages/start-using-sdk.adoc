...
include::4.5@sdk:shared:partial$install-couchbase.adoc[tag=section_gb4_psc_kv]
...
Information on new features, fixes, known issues as well as information on how to install older release versions is xref:2.6@relnotes-java-sdk.adoc#version-2-3-7-19-january-2017[in the release notes].
...
The reference for the latest version can be found http://docs.couchbase.com/sdk-api/couchbase-java-client-2.3.6/[here^].
