...
It is designed to be quite low level and only exposes a message-oriented API -- the APIreference is https://docs.couchbase.com/sdk-api/couchbase-core-io[here^].
