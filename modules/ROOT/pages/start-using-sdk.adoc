...
:page-aliases: getting-started,hello-couchbase,java-intro,hello-world:start-using-sdk
...
IMPORTANT: At least Java 6 is required, all newer Java versions are supported (and encouraged), up to and including Java 11.
