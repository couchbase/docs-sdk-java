...
[#table_sdk_versions]
|===
| | _Under 1.4_ | _SDK 1.4_ | _SDK 2.0, 2.1_ | *SDK 2.2, 2.3* | *SDK 2.4*

| _SDK released for >_
| _N/A (Archived)_
| _Bug fixes only_
| _N/A (Archived)_
| _Bug fixes and minor features Back ports_
...
|===
| | Server 1.8 | Server 2.0 | Server 2.5 | Server 3.0, 3.1 | Server 4.0, 4.1 | Server 4.5, 4.6
...
The following Oracle JDKs are supported for *Java SDK 1.4 and 2.0 - 2.3*:
