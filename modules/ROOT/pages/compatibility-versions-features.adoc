...
NOTE: Check the Spring Data Couchbase's compile dependencies -- older versions, such as 3.0, may link an out-of-date version of the Java SDK in their dependencies list, although a supported version should be in the `updates`.
