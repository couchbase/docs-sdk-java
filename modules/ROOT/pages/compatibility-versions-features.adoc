...
IMPORTANT: With sdk-authentication-overview.adoc[RBAC^], in Couchbase Server 5.0, authentication will depend upon access privileges, and upgrading to 5.0 with existing buckets, or upgrading Server, will require taking these changes into account.
