...
This xref:compatibility-versions-features.html#1-x-2-x-migration-getting-started[guide] helps you migrate from the previous generation of the Java SDK (version `1.4.x`) to this new generation SDK (version `2.x`).
