...
Null out request and response in json parser after completion. This change will make sure that leftovers of a previous (i.e. query) request can be cleaned up by th GC more quickly.
