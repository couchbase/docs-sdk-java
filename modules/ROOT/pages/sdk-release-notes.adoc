...
Version 2.7.13 is a bugfix release of the 2.7 series.
...
To provide better compatibility with cluster upgrades and query prepared statements on Couchbase Server 6.5 and later, the SDK now transparently retries the 4040 reponse code similar to related error codes.
