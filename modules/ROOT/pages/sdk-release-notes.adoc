...
== Version 2.7.23 (31 January 2022)

Version 2.7.23 is a bugfix release of the 2.7 series, bringing enhancements over the last stable release.

http://packages.couchbase.com/clients/java/2.7.23/Couchbase-Java-Client-2.7.23.zip[Download] | http://docs.couchbase.com/sdk-api/couchbase-java-client-2.7.23/[API Reference] | http://docs.couchbase.com/sdk-api/couchbase-core-io-1.7.23/[Core API Reference]
...
* http://issues.couchbase.com/browse/JVMCBC-1052[JVMCBC-1052]:
Updated the internal `Netty` dependency to 4.1.73.Final` and `Jackson` to `2.12.6`.
* http://issues.couchbase.com/browse/JVMCBC-1049[JVMCBC-1049]:
Don't expose non-existent services in `META-INF/services`.

== Version 2.7.22 (2nd November 2021)

Version 2.7.22 is a bugfix release of the 2.7 series, bringing enhancements over the last stable release.

http://packages.couchbase.com/clients/java/2.7.22/Couchbase-Java-Client-2.7.22.zip[Download] | http://docs.couchbase.com/sdk-api/couchbase-java-client-2.7.22/[API Reference] | http://docs.couchbase.com/sdk-api/couchbase-core-io-1.7.22/[Core API Reference]

The supported and tested dependencies for this release are:

* com.couchbase.client:**java-client:2.7.22**
* com.couchbase.client:**core-io:1.7.22**
* io.reactivex:**rxjava:1.3.8**
* io.opentracing:**opentracing-api:0.31.0**

=== Bug Fixes

* http://issues.couchbase.com/browse/JVMCBC-1028[JVMCBC-1028]:
Updated the internal `Netty` dependency to 4.1.69.Final`.
* http://issues.couchbase.com/browse/JVMCBC-1029[JVMCBC-1029]:
Updated the internal `Jackson` dependency to `2.12.5`.
* http://issues.couchbase.com/browse/JVMCBC-1030[JVMCBC-1030]:
Make sure `ping` also sends the user credentials. 
Previous behavior has not been identified as harmful (service ping endpoints must not be authenticated), but in some services (like Query) this may lead to noisy log messages.


== Version 2.7.21 (14th September 2021)

Version 2.7.21 is a bugfix release of the 2.7 series, bringing enhancements over the last stable release.

http://packages.couchbase.com/clients/java/2.7.21/Couchbase-Java-Client-2.7.21.zip[Download] | http://docs.couchbase.com/sdk-api/couchbase-java-client-2.7.21/[API Reference] | http://docs.couchbase.com/sdk-api/couchbase-core-io-1.7.21/[Core API Reference]

The supported and tested dependencies for this release are:

* com.couchbase.client:**java-client:2.7.21**
* com.couchbase.client:**core-io:1.7.21**
* io.reactivex:**rxjava:1.3.8**
* io.opentracing:**opentracing-api:0.31.0**

=== Bug Fixes

* http://issues.couchbase.com/browse/JVMCBC-1011[JVMCBC-1011]:
Updated the internal Netty dependency to 4.1.68.Final and Disruptor to 3.4.4.
* http://issues.couchbase.com/browse/JVMCBC-1001[JVMCBC-1001]:
Fixed a race condition where under certain conditions HTTP pools (i.e. for Query) would not be marked as free once a socket disconnected/reconnected, and won't accept new requests (which would time out).


== Version 2.7.20 (8th April 2021)

Version 2.7.20 is a bugfix release of the 2.7 series, bringing enhancements over the last stable release.

http://packages.couchbase.com/clients/java/2.7.20/Couchbase-Java-Client-2.7.20.zip[Download] | http://docs.couchbase.com/sdk-api/couchbase-java-client-2.7.20/[API Reference] | http://docs.couchbase.com/sdk-api/couchbase-core-io-1.7.20/[Core API Reference]

The supported and tested dependencies for this release are:

* com.couchbase.client:**java-client:2.7.20**
* com.couchbase.client:**core-io:1.7.20**
* io.reactivex:**rxjava:1.3.8**
* io.opentracing:**opentracing-api:0.31.0**

=== Bug Fixes

* http://issues.couchbase.com/browse/JVMCBC-952[JVMCBC-952]:
Update the internal Netty dependency to 4.1.63.Final.
* http://issues.couchbase.com/browse/JVMCBC-953[JVMCBC-953]:
Improve the "not my vbucket" transient partition movement during rebalance.
* http://issues.couchbase.com/browse/JVMCBC-945[JVMCBC-945]:
Explicitly handle an UnknownHostException during a failed connect attempt.

== Version 2.7.19 (17th February 2021)

Version 2.7.19 is a bugfix release of the 2.7 series, bringing enhancements over the last stable release.

http://packages.couchbase.com/clients/java/2.7.19/Couchbase-Java-Client-2.7.19.zip[Download] | http://docs.couchbase.com/sdk-api/couchbase-java-client-2.7.19/[API Reference] | http://docs.couchbase.com/sdk-api/couchbase-core-io-1.7.19/[Core API Reference]

The supported and tested dependencies for this release are:

* com.couchbase.client:**java-client:2.7.19**
* com.couchbase.client:**core-io:1.7.19**
* io.reactivex:**rxjava:1.3.8**
* io.opentracing:**opentracing-api:0.31.0**

=== Bug Fixes

* http://issues.couchbase.com/browse/JVMCBC-903[JVMCBC-903]:
Also handle a HTTP 409 status code properly when returned from the server.
* http://issues.couchbase.com/browse/JVMCBC-922[JVMCBC-922]:
Updates shadowed Jackson and Netty dependencies to their latest bugfix versions.
* http://issues.couchbase.com/browse/JVMCBC-923[JVMCBC-923]:
Uses the hostname from the server config for the HTTP host header instead of always using the IP address.
...
Fixed an issue which surfaced with 2.7.17 where connections over slower networks (i.e. over WAN) would be prematurely cleaned up, causing HTTP-based operations to time out. 
Note that only 2.7.17 is affected, because earlier releases had a higher check interval where the relevant code path would not come into effect.

== Version 2.7.17 (9th November 2020)

*PLEASE NOTE:* This version contains a defect which may cause timeouts on slower networks or connections over WAN. 
We recommend to skipping this version and going straight to 2.7.18.
...
* http://issues.couchbase.com/browse/JVMCBC-902[JVMCBC-902]:
This version contains a regression which may cause timeouts on slower networks or connections over WAN. 
We recommend skipping this version and going straight to 2.7.18.
