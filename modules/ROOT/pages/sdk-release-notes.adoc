...
Make sure ping also send the user credentials. Previous behavior has not been identified as harmful (service ping endpoints must not be authenticated), but in some services (like query) this may lead to noisy log messages.
