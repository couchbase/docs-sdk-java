...
The recommendation is keeping it at 1 unless there is other evidence -- multiple threads calling in at around the same time will be easily pipelined together over a single socket..
Replaced the deprecated `kvEndpoints`.
