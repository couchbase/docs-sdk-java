...
// intro
include::{version-common}@sdk:shared:partial$health-check.adoc[tag="intro"]




// Uses
include::{version-common}@sdk:shared:partial$health-check.adoc[tag="uses"]
...
[source,java]
----
include::devguide:example$java/HealthCheck.java[tag=ping-basic,indent=0]
----
...
[source,java]
----
include::devguide:example$java/HealthCheck.java[tag=ping-json-export,indent=0]
----
...
[source,java]
----
include::devguide:example$java/HealthCheck.java[tag=ping-options,indent=0]
----
...
[source,java]
----
include::devguide:example$java/HealthCheck.java[tag=diagnostics-basic,indent=0]
----
