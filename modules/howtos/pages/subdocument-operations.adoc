...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=imports,indent=0]
----

.Retrieve Sub-Document value
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=get,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=exists,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=combine,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=get-future,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=get-reactive,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=upsert,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=insert,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=multi,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=array-append,indent=0]
----

[source,java]
----
include::devguide:example$java/SubDocument.java[tag=array-prepend,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=array-create,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=array-upsert,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=array-unique,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=array-insert,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=counter-inc,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=counter-dec,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=create-path,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=lookup-in-any-replica,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=lookup-in-all-replicas,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=concurrent,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=cas,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=old-durability,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SubDocument.java[tag=new-durability,indent=0]
----
...
----
include::devguide:example$java/SubDocument.java[tag=full_doc_replace,indent=0]
----
