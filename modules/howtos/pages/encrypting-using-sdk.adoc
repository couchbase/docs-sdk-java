...
NOTE: The encryption code is packaged as an optional library because it is released under a https://github.com/couchbase/java-couchbase-encryption/blob/master/LICENSE.md[different license^] from the Couchbase Java SDK.
