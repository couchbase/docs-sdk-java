...
Please see xref:6.5@server:introduction:distributed-acid-transactions.adoc[our introduction to ACID Transactions] for a guide to the benefits and trade-offs of multi-document transactions.
...
* There’s plenty of explanation about how Transactions work in Couchbase in our xref:6.5@server:introduction:distributed-acid-transactions.adoc[Transactions documentation].
