...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=examples,indent=0]
----
--
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=examplesReactive,indent=0]
----
--
====
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=logging,indent=0]
----
--
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=async_logging,indent=0]
----
--
====
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=logger,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=insert,indent=0]
----
--
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=insertReactive,indent=0]
----
--
====
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=get,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=get-catch,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=getReadOwnWrites,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=replace,indent=0]
----
--
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=replaceReactive,indent=0]
----
--
====
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=remove,indent=0]
----
--
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=removeReactive,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=queryExamplesSelectScope,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=queryExamplesUpdate,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=queryExamplesComplex,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=queryInsert,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=queryOptions,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=queryRyow,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=concurrentOps,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=config,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=config-easy,indent=0]
----
