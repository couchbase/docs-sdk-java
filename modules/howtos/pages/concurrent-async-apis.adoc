...
include::{version-common}@sdk:shared:partial$best-practices.adoc[tag=bulk-get-sidebar]
...
Finally, for even more advanced retry policies you can utilize the retry functionality in the https://projectreactor.io/docs/extra/release/api/reactor/retry/Retry.html[reactor-extra^] package.
