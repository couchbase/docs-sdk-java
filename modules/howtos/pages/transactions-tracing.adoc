...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=tracing,indent=0]
----
...
[source,java]
----
include::devguide:example$java/TransactionsExample.java[tag=tracing-wrapped,indent=0]
----
