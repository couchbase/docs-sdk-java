...
[source,java]
----
include::devguide:example$java/Queries.java[tag=imports,indent=0]
----
...
[source,java]
----
include::devguide:example$java/SimpleQueryCloud.java[tag=class,indent=0]
----
--
...
[source,java]
----
include::devguide:example$java/SimpleQuery.java[tag=class,indent=0]
----
--
====
...
[source,java]
----
include::devguide:example$java/Queries.java[tag=named,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Queries.java[tag=positional,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Queries.java[tag=rowsasobject,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Queries.java[tag=printmetrics,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Queries.java[tag=scanconsistency,indent=0]
----
...
//[source,java]
//----
//include::devguide:example$java/Queries.java[tag=connect-bucket-and-scope,indent=0]
//include::devguide:example$java/Queries.java[tag=scanconsistency_with,indent=0]
//----
//
...
[source,java]
----
include::devguide:example$java/Queries.java[tag=clientcontextid,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Queries.java[tag=readonly,indent=0]
----
...
include::devguide:example$java/Queries.java[tag=scope-level-query,indent=0]
