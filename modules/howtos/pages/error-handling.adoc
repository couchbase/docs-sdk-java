...
WARNING: You will need to upgrade to at least Couchbase Java SDK 3.0.9, if you are on an earlier version, to successfully override `BestEffortRetryStrategy`.
