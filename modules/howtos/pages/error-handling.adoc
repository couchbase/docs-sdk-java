...
=== TimeoutException -- Ambiguous or Unambiguous
...
[source,java]
----
include::devguide:example$java/ErrorHandling.java[tag=readonly,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ErrorHandling.java[tag=getfetch,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ErrorHandling.java[tag=getcatch,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ErrorHandling.java[tag=tryupsert,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ErrorHandling.java[tag=reactivesub,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ErrorHandling.java[tag=reactivefallback,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ErrorHandling.java[tag=reactiveretry,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ErrorHandling.java[tag=customglobal,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ErrorHandling.java[tag=customreq,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ErrorHandling.java[tag=customclass,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ErrorHandling.java[tag=failfastcircuit,indent=0]
----
