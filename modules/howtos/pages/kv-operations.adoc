= Data Operations
:description: The Data Service offers the simplest way to retrieve or mutate data where the key is known.
...
// :example-source: 3.13@java-sdk:devguide:example$java/Queries.java
:page-toclevels: 3
...
// intro
include::{version-common}@sdk:shared:partial$data-service.adoc[tag=intro]
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=imports]
----
////


//{sqlpp} vs. Key-Value
include::{version-common}@sdk:shared:partial$data-service.adoc[tag=sql-vs-kv]
...
include::{version-common}@sdk:shared:partial$data-service.adoc[tag=subdoc]
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=upsert,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=apis,indent=0]
----
=====
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=get-simple,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=get,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=replace,indent=0]
----
...
include::{version-common}@sdk:shared:partial$data-service.adoc[tag=cas]
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=replace-retry,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=remove,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=durability,indent=0]
----
...
If you need stronger durability guarantees,
you can take advantage of the xref:concept-docs:durability-replication-failure-considerations.adoc#durable-writes[Durable Write] feature, 
in which Couchbase Server (self-managed or Capella) will only return success to the SDK after the requested replication level has been achieved. 
...
A client verified durability API was necessary with older, no longer supported version of Couchbase Server.
This API is still avaialable, but there are few cases where you would want to use this less performant option.
Details can be found 
https://docs-archive.couchbase.com/java-sdk/3.3/concept-docs/durability-replication-failure-considerations.html#older-server-versions[in our archived docs].
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=expiry-insert,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=expiry-insert-instant,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=expiry-get,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=preserve-expiry,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=expiry-replace,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=expiry-touch,indent=0]
----
...
It is possible to perform scoped key-value operations on named xref:{version-server}@server:learn:data/scopes-and-collections.adoc[`Collections`].
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=named-collection-upsert,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=rangeScanAllDocuments,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=rangeScanPrefix,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=rangeScanSample,indent=0]
----
...
[source,java]
----
include::devguide:example$java/KvOperations.java[tag=rangeScanAllDocumentIds,indent=0]
----
...
include::{version-common}@sdk:shared:partial$data-service.adoc[tag=resources]
