...
The complete code sample used on this page can be downloaded from https://github.com/couchbase/docs-sdk-java/tree/3.0dp1/modules/howtos/examples/KvOperations.java[here].
