...
[source,java]
----
include::devguide:example$java/Search.java[tag=simple,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Search.java[tag=squery,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Search.java[tag=limit,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Search.java[tag=ryow,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Search.java[tag=highlight,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Search.java[tag=sort,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Search.java[tag=facets,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Search.java[tag=fields,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Search.java[tag=collections,indent=0]
----
