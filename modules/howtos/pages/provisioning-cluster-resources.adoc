...
:page-aliases: ROOT:managing-clusters.adoc,concept-docs:buckets-and-clusters.adoc
:page-toclevels: 2
...
[abstract]
{description}
Common use cases are outlined here, less common use cases are covered in the 
...
[source,java]
----
include::devguide:example$java/ProvisioningResourcesBuckets.java[tag=creatingbucketmgr,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ProvisioningResourcesBuckets.java[tag=createBucket,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ProvisioningResourcesBuckets.java[tag=updateBucket,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ProvisioningResourcesBuckets.java[tag=removeBucket,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ProvisioningResourcesBuckets.java[tag=flushBucket,indent=0]
----
...
[source,java]
----
include::devguide:example$java/CollectionManagerExample.java[tag=create-collection-manager,indent=0]
----
...
[source,java]
----
include::devguide:example$java/CollectionManagerExample.java[tag=create-scope,indent=0]
----
...
[source,java]
----
include::devguide:example$java/CollectionManagerExample.java[tag=create-collection,indent=0]
----
...
[source,java]
----
include::devguide:example$java/CollectionManagerExample.java[tag=drop-collection,indent=0]

include::devguide:example$java/CollectionManagerExample.java[tag=drop-scope,indent=0]
...
[source,java]
----
include::devguide:example$java/CollectionManagerExample.java[tag=scopeAdmin, indent=0]
...
[source,java]
----
include::devguide:example$java/QueryIndexManagerExample.java[tag=creating-index-mgr,indent=0]
----
...
[source,java]
----
include::devguide:example$java/QueryIndexManagerExample.java[tag=primary,indent=0]
----
...
[source,java]
----
include::devguide:example$java/QueryIndexManagerExample.java[tag=secondary,indent=0]
----
...
[source,java]
----
include::devguide:example$java/QueryIndexManagerExample.java[tag=defer-indexes,indent=0]
----
...
[source,java]
----
include::devguide:example$java/QueryIndexManagerExample.java[tag=drop-primary-or-secondary-index,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ProvisioningResourcesViews.java[tag=viewmgr,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ProvisioningResourcesViews.java[tag=createView,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ProvisioningResourcesViews.java[tag=getView,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ProvisioningResourcesViews.java[tag=publishView,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ProvisioningResourcesViews.java[tag=removeView,indent=0]
----
