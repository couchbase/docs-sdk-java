...
:nav-title: Managing Users
:page-aliases: ROOT:sdk-user-management-example

[abstract]
The Java SDK now lets you create _users_, assign them _roles_ and associated _privileges_, and remove them from the system -- as well as working with groups.


include::6.5@sdk:shared:partial$user-management-example.adoc[tag=create-role]


// This is currently 2.7 / 5.5
[source,java]
----
