...
[source,java]
----
include::devguide:example$java/UserManagementExample.java[tag=usermanagement_1,indent=0]
----

.Listing Users
[source,java]
----
include::devguide:example$java/UserManagementExample.java[tag=usermanagement_2,indent=0]
----
...
[source,java]
----
include::devguide:example$java/UserManagementExample.java[tag=usermanagement_3,indent=0]
----
