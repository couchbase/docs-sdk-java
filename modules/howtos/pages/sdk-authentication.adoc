...
[source,java]
----
include::devguide:example$java/Auth.java[tag=rbac-simple,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Auth.java[tag=rbac-clusteroptions,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Auth.java[tag=rbac-pwd,indent=0]
----
...
[source,java]
----
include::devguide:example$java/Auth.java[tag=certauth,indent=0]
----
