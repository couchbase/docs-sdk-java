...
[source,java]
----
include::example$working_with_collections.java[tag=working_with_collections_1,indent=0];
----
...
[source,java]
----
include::example$working_with_collections.java[tag=working_with_collections_2,indent=0];
----
...
[source,java]
----
include::example$working_with_collections.java[tag=working_with_collections_3,indent=0];
----
