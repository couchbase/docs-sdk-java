...
[source,java]
----
include::devguide:example$java/ClientSettingsExample.java[tag=client_settings_1,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ClientSettingsExample.java[tag=client_settings_2,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ClientSettingsExample.java[tag=client_settings_connection_string,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ClientSettingsExample.java[tag=client_settings_4,indent=0]
----
<1> When specifying durations, `s` stands for seconds.
Other valid qualifiers are `ns` for nanoseconds, `us` for microseconds, `ms` for milliseconds, and `m` for minutes.
...
[source,java]
----
include::devguide:example$java/ClientSettingsExample.java[tag=client_settings_5,indent=0]
----
...
==== Custom TLS Trust Manager Factory
...
[source,java]
----
include::devguide:example$java/ClientSettingsExample.java[tag=client_settings_6,indent=0]
----
...
==== Max HTTP Endpoints per Service per Node
...
[source,java]
----
include::devguide:example$java/ClientSettingsExample.java[tag=client_settings_7,indent=0]
----
...
[source,java]
----
include::devguide:example$java/ClientSettingsExample.java[tag=client_settings_8,indent=0]
----
...
==== Key-Value Durable Operation Timeout
...
[source,java]
----
include::devguide:example$java/ClientSettingsExample.java[tag=client_settings_9,indent=0]
----
...
==== Document Minimum Compressibility
...
[source,java]
----
include::devguide:example$java/ClientSettingsExample.java[tag=client_settings_10,indent=0]
----
