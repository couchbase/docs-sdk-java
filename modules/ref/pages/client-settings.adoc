...
NOTE: Prior to xref:3.0@java-sdk:project-docs:sdk-release-notes.adoc#version-3-0-6-14-july-2020[Java SDK 3.0.6], the default value for `idleHttpConnectionTimeout` was 30s.
...
Default: `true`
+
System Property: `com.couchbase.env.CompressionExample.enabled(boolean)`
+
