...
[source,java]
----
include::example$data_structures.java[tag=data_structures_1,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_2,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_3,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_4,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_5,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_6,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_7,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_8,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_9,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_10,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_11,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_12,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_13,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_14,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_15,indent=0];
----
|===
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_16,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_17,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_18,indent=0];
----
...
[source,java]
----
include::example$data_structures.java[tag=data_structures_19,indent=0];
----
////
