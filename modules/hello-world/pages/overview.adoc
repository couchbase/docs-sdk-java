...
The Couchbase {name-sdk} allows {name_platform} applications to access a Couchbase operational cluster --
...
[source,java]
----
include::devguide:example$java/KvOperations.java[indent=0,tag=durability]
----
--
