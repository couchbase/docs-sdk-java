...
[TIP] Couchbase -- including Capella -- is designed to run in a LAN-like environment.
...
[NOTE] The `application.properties` file has the connection information to connect to your Capella cluster.
...
include::assets/images/app-startup-spring-boot.png[]
