...
[source,java]
----
include::example$sample_application.java[tag=sample_application_1,indent=0];
----
...
[source,java]
----
include::example$sample_application.java[tag=sample_application_2,indent=0];
----
...
[source,java]
----
include::example$sample_application.java[tag=sample_application_3,indent=0];
----
