...
:description: Discover how to program interactions with Spring Data and Couchbase Server via the Data, Query, \
and Search services -- using the Travel Sample Application with the built-in Travel Sample data Bucket.
:nav-title: Spring Data Travel Sample App
