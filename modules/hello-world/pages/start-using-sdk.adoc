...
The latest version (as of July 2020) is https://search.maven.org/artifact/com.couchbase.client/java-client/3.0.6/jar[3.0.6].
...
[source,groovy]
----
implementation 'com.couchbase.client:java-client:3.0.6'
----
...
If you are planing to use Spring Data Couchbase, see the xref:project-docs:compatibility.adoc#spring-compat[notes on version compatibility].
