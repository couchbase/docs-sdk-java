...
The latest version (as of October 2020) is https://search.maven.org/artifact/com.couchbase.client/java-client/3.0.9/jar[3.0.9].
...
[source,groovy]
----
implementation 'com.couchbase.client:java-client:3.0.9'
----
