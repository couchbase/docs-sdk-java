...
The latest version (as of June 2020) is https://search.maven.org/artifact/com.couchbase.client/java-client/3.0.5/jar[3.0.5].
...
[source]
----
implementation 'com.couchbase.client:java-client:3.0.5'
----
