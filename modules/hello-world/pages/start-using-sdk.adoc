...
:page-partial:
:page-aliases: ROOT:getting-started,ROOT:start-using,ROOT:hello-couchbase,ROOT:start-using-sdk,ROOT:java-intro,ROOT:tutorial,server:sdks:java-2.2/download-links,server:sdk:java/start-using-sdk
