...
WARNING: These pages cover the second _Alpha_ of the Couchbase Java SDK 3.0 (Alpha 2).
As such they are likely to change without notice.
The Alpha2 code _should not_ be used in production.
...
The API reference is generated for each release and can be found http://docs.couchbase.com/sdk-api/couchbase-java-client-3.0.0-alpha.2/[here].
