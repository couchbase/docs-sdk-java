...
The latest version (as of January 2021) is https://search.maven.org/artifact/com.couchbase.client/java-client/3.1.1/jar[3.1.1].
...
[source,groovy]
----
implementation 'com.couchbase.client:java-client:3.1.1'
----
