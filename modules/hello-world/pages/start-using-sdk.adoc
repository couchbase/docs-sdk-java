...
:page-partial:
:page-aliases: ROOT:getting-started,ROOT:start-using,ROOT:hello-couchbase,ROOT:start-using-sdk,ROOT:java-intro
...
[source]
----
implementation 'com.couchbase.client:java-client:3.0.4'
----
