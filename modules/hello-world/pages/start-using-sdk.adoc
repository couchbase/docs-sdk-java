...
Here we will use the `DefaultCollection`, which covers the whole Bucket and is also must be used when connecting to a 6.5 cluster or earlier.
...
You can learn more about N1QL queries on the xref:howtos:n1ql-queries-with-sdk.adoc[Query page]. Other services (like analytics, search or views) work very similar to the two shown above. Please refer to their respective documentation sections to learn more.
