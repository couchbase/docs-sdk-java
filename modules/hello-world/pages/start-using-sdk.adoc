...
The latest 3.1.x version (as of August 2021) is https://search.maven.org/artifact/com.couchbase.client/java-client/3.1.7/jar[3.1.7].
...
[source,groovy]
----
implementation 'com.couchbase.client:java-client:3.1.7'
----
