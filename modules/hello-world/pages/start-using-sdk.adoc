...
[source]
----
implementation 'com.couchbase.client:java-client:3.0.2'
----
...
The API reference is generated for each release and can be found in the xref:project-docs:sdk-release-notes.adoc[Release Notes].
